...
This command has subcommands that enable you to import, export, internationalization files
...
.. option:: -w,--overwrite
   ...
   (Optional) Overwrite existing translation when importing.

.. option:: -l,--language

   Language code of the translations in the files.
...
.. option:: --pwd <password>
   ...
   the password that will be used to symmetrically obfuscate content.
...
This command uploads a module to a remote Odoo server and installing it.
